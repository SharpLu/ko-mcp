...
export const PROBES: Record<string, Record<string, unknown>> = {
  ...
  get_insider_trades: { ticker: 'AAPL', executive_cik: '1214128', limit: 25 },
  ...
  get_economic_indicators: { category: 'cpi', days: 365 },
  get_ftd_data: { ticker: 'GME', days: 90 },
  get_financial_stress: { days: 365 },
  get_crypto_exposure: {},
